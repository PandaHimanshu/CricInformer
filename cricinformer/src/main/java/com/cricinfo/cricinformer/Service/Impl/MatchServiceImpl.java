package com.cricinfo.cricinformer.Service.Impl;
...
import com.cricinfo.cricinformer.Repositories.MatchRepository;
    ...
    public List<Match> getLiveMatchScores() {
        ...
        try {
            ...
            for (Element match : liveScoreElements) {
                ...
                String teamsHeading = ((org.jsoup.nodes.Element) match).select("h3.cb-lv-scr-mtch-hdr").select("a").text();
